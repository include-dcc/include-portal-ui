...
export const getTooltip = (node: any) => (
  ...
  >
    ...
    <div style={{ paddingLeft: '18px' }}>
      {intl.getHTML(
        'screen.dataExploration.tabs.summary.graphs.mostFrequentPhenotypes.tooltip.exactCount',
        { count: node.data.value },
      )}
    </div>
    <div style={{ paddingLeft: '18px' }}>
      {intl.getHTML(
        'screen.dataExploration.tabs.summary.graphs.mostFrequentPhenotypes.tooltip.allCount',
