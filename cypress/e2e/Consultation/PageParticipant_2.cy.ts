...
describe('Page d\'un participant - Vérifier les informations affichées', () => {
  ...
  it('Panneau Phenotypes', () => {
    ...
    cy.get('[id="phenotype"] tr[class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(2).contains('Observed').should('exist');
    cy.get('[id="phenotype"] tr[class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(2).find('[class*="ant-tag-green"]').should('exist');
    cy.get('[id="phenotype"] tr[class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(3).contains('1').should('exist');
    cy.get('[id="phenotype"] tr[class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(3).contains('year').should('exist');
    cy.get('[id="phenotype"] tr[class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(3).contains('134').should('exist');
    cy.get('[id="phenotype"] tr[class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(3).contains('days').should('exist');
    cy.get('[id="phenotype"] tr[class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(4).contains(/\d{1}/).should('exist');
    ...
    cy.get('[id="phenotype"] tr[class*="ant-table-row"]').eq(1).find('td[class="ant-table-cell"]').eq(2).contains('Observed').should('exist');
    cy.get('[id="phenotype"] tr[class*="ant-table-row"]').eq(1).find('td[class="ant-table-cell"]').eq(2).find('[class*="ant-tag-green"]').should('exist');
    cy.get('[id="phenotype"] tr[class*="ant-table-row"]').eq(1).find('td[class="ant-table-cell"]').eq(3).contains('1').should('exist');
    cy.get('[id="phenotype"] tr[class*="ant-table-row"]').eq(1).find('td[class="ant-table-cell"]').eq(3).contains('year').should('exist');
    cy.get('[id="phenotype"] tr[class*="ant-table-row"]').eq(1).find('td[class="ant-table-cell"]').eq(3).contains('234').should('exist');
    cy.get('[id="phenotype"] tr[class*="ant-table-row"]').eq(1).find('td[class="ant-table-cell"]').eq(3).contains('days').should('exist');
    cy.get('[id="phenotype"] tr[class*="ant-table-row"]').eq(1).find('td[class="ant-table-cell"]').eq(4).contains(/\d{1}/).should('exist');
  });
