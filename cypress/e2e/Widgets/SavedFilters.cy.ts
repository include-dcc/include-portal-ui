...
describe('Page Dashboard - Widget Saved Filters', () => {
  ...
  it('Valider les liens disponibles - Data Exploration du Tooltip', () => {
    ...
    cy.get('[class*="DataExploration_title"]').should('exist');
  });
...
describe('Page Dashboard - Widget Saved Filters', () => {
  ...
  it('Valider les liens disponibles - Bouton Delete', () => {
    ...
    cy.clickAndIntercept('[class="ant-modal-content"] button[class*="ant-btn-dangerous"]', 'DELETE', '**/saved-filters/**', 1);
...
describe('Page Dashboard - Widget Saved Filters', () => {
  ...
  it('Valider les liens disponibles - Bouton Edit', () => {
    ...
    cy.get('[class="ant-modal-content"] input').filter(':visible').clear().type('Cypress_FB');
